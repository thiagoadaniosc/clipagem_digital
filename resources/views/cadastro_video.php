...
<div class="row col-lg-11 col-xl-6 col-md-11 col-sm-11 justify-content-center formBody">
    <h1 class="text-center"> <i class="fa fa-film"></i> Cadastro de Clipagem </h1>
    <form class="col-lg-12 col-sm-8 row" method="post" action="/cadastrar" enctype="multipart/form-data">
        ...
        <!-- <div class="form-group d-none col-lg-6">
            <input type="hidden" class="form-control col-lg-12" name="editoria" value=" ">
        </div> -->
        ...
        <!-- <div class="form-group col-lg-6 d-none">
            <input class="form-control" type="hidden" name="pagina" value=" ">
        </div> -->
      ...
      <!--   <div class=" form-group col-lg-6 justify-content-center ">
        ...
        <div class="form-group col-lg-12">
            <input id="file_video" name="file" type="file" style="height: 50px;" class="file" data-show-upload="false" data-show-caption="true"
                data-msg-placeholder="Selecione um {video} para a matéria..." required>
        </div>
        <div class="form-group col-lg-12">
            <input type="hidden" name="tipo_formato" value="video">
